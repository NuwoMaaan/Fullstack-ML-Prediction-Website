    ...
    <Route path="/" element={
        <Container component="main" sx={{ mt: 8, mb: 2, flex: 1 }}>
            ...
            <Routes>
                ...
                <Route path="/predictTemp" element={<div>Temperature Prediction Page</div>} />
                <Route path="/predictElectricity" element={<div>Electricity Prediction Page</div>} />
                <Route path="/predictInfluenza" element={<div>Influenza Prediction Page</div>} />
            </Routes>
